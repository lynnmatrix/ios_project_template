//
//  DiscoveryDefaultCSSStyleSheet.m
//  Discovery
//
...
#import "DiscoveryDefaultCSSStyleSheet.h"
#import "Three20Style/UIColorAdditions.h"

@implementation DiscoveryDefaultCSSStyleSheet
...
- (TTStyle*) labelPrompt{
    TTTextStyle* textStyle = [TTTextStyle styleWithFont:TTSTYLEVAR(font)
                                                  color:DSSTYLEVAR(hintTextColor)
...
- (TTStyle*) labelOrange
{
    return [TTSolidFillStyle styleWithColor:[UIColor clearColor] next:
            [TTTextStyle styleWithFont:TTSTYLEVAR(font) 
                                 color:DSSTYLEVAR(orangeTextColor)
                         textAlignment:UITextAlignmentLeft next:nil]
            ];
}
...
- (TTStyle*) orangeText
{
    return [TTTextStyle styleWithColor:DSSTYLEVAR(orangeTextColor) next:nil];
}
